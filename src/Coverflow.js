...
var useTouchEvent_1 = require("./hooks/useTouchEvent");
var useKeyPress_1 = require("./hooks/useKeyPress");
var useWindowSize_1 = require("./hooks/useWindowSize");
var constants_1 = require("./utils/constants");
var clamp_1 = require("./utils/clamp");
var fetchImages_1 = require("./utils/fetchImages");
...
var Coverflow = function (props) {
    var _a;
    var className = props.className, elements = props.elements, slidesPerSide = props.slidesPerSide, _b = props.rotation, rotation = _b === void 0 ? constants_1.ROTATION : _b, _c = props.opacityInterval, opacityInterval = _c === void 0 ? constants_1.OPACITY_ORDER : _c, _d = props.scaleInterval, scaleInterval = _d === void 0 ? constants_1.SCALE_ORDER : _d;
    /**
     * Sliders per side
     */
    var diff = slidesPerSide + 1 - opacityInterval.length;
    var isSlidesGreaterThanOpacityLength = diff >= 0;
    var slidesGreaterThanOpacityLength = react_1.useMemo(function () { return function () { return __spreadArrays(opacityInterval, Array(diff).fill(opacityInterval[opacityInterval.length - 1]), [0]); }; }, [diff, opacityInterval]);
    var slidesLessThanOpacityLength = react_1.useMemo(function () { return function () { return __spreadArrays(opacityInterval.slice(0, slidesPerSide + 1), [0]); }; }, [
        opacityInterval,
        slidesPerSide,
    ]);
    var opacityIntervalOverride = react_1.useMemo(function () {
        return slidesPerSide
            ? isSlidesGreaterThanOpacityLength
                ? slidesGreaterThanOpacityLength()
                : slidesLessThanOpacityLength()
            : constants_1.OPACITY_ORDER;
    }, [isSlidesGreaterThanOpacityLength, slidesGreaterThanOpacityLength, slidesLessThanOpacityLength, slidesPerSide]);
    var coverflowRef = react_1.useRef();
    var _e = react_1.useState([]), leftEdgeList = _e[0], setLeftEdgeList = _e[1];
    var _f = react_1.useState([]), elementsList = _f[0], setElementsList = _f[1];
    var _g = react_1.useState([]), imageInfoList = _g[0], setElementInfoList = _g[1];
    var _h = react_1.useState(0), currentIndex = _h[0], setCurrentIndex = _h[1];
    var _j = useWindowSize_1["default"](), height = _j.height, width = _j.width;
    var leftArrowKeyPress = useKeyPress_1["default"]('ArrowLeft');
    var rightArrowKeyPress = useKeyPress_1["default"]('ArrowRight');
    var _k = useTouchEvent_1["default"](), ref = _k[0], _l = _k[1], isMoving = _l.isMoving, isLeft = _l.isLeft, isRight = _l.isRight;
    ...
    detachedElements.forEach(function (x) { return x.parentElement.removeChild(x); });
    /**
     * Image fetch
     */
    react_1.useEffect(function () {
        var fetch = function (originalElementList) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetchImages_1["default"](originalElementList)];
                    case 1:
    ...
    react_1.useLayoutEffect(function () {
        ...
        elementsList.forEach(function (element, index) {
            ...
            var scale = scaleInterval[clamp_1["default"](absDistanceFromMiddle, 0, scaleInterval.length - 1)];
            var imageDimension = resizeImage_1["default"](coverflowHeight, coverflowWidth, element);
            ...
            var opacity = opacityIntervalOverride[clamp_1["default"](absDistanceFromMiddle, 0, opacityIntervalOverride.length - 1)];
            ...
            if (distanceFromMiddle < 0) {
                ...
                if (nextImage) {
                    ...
                    var nextScale = scaleInterval[clamp_1["default"](Math.abs(nextImageDistanceFromCenter), 0, scaleInterval.length - 1)];
                    var nextImageDimension = resizeImage_1["default"](coverflowHeight, coverflowWidth, nextImage);
    ...
    return (<div className="main">
      <div className={(className !== null && className !== void 0 ? className : '') + " coverflow-wrapper"} ref={ref}>
        <div ref={coverflowRef} className="coverflow" style={{
        ...
        return (<div key={index} className={"coverflow__image-container " + (isVisible ? 'coverflow__image-container--visible' : '') + " " + (isCurrentImage ? 'coverflow__image-container--active' : '')} style={{
            zIndex: zIndex,
            left: leftPosition + "px",
            width: scaledWidth + "px",
            height: height + "px"
        }}>
                <button className="coverflow__button" tabIndex={isCurrentImage && href ? 0 : -1} onClick={function () {
            if (isVisible) {
            ...
            cursor: "" + (isCurrentImage && href ? 'pointer' : '')
                  ...
                  <div className="coverflow__element" style={{
            height: height + "px",
            width: width + "px",
            opacity: "" + opacity
        }}>
