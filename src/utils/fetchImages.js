...
var allSettled_1 = require("./allSettled");
var fetchElement = function (element) {
    return new Promise(function (resolve, reject) {
        ...
        allSettled_1["default"](tasks).then(function () { return resolve(element); })["catch"](function () { return reject('subimg oops'); });
    });
};
var fetchElements = function (elements) {
    var promises = elements.map(fetchElement);
    return allSettled_1["default"](promises);
};
exports["default"] = fetchElements;
